...
banlist_file = open("Everchanging Format 2.lflist.conf","w+")
banlist = []
toadd = []
selectoutname = ""

#grab current banlist
banlist_url = urlopen("https://raw.githubusercontent.com/NoLegs1/everchanging/main/Everchanging%20Format%202.lflist.conf")
...
# write to file
banlist_file.write('''!Everchanging Format 2\n$whitelist\n#Forbidden''')
i = 0
for line in banlist:
    line = line.replace(" ", "")
    if int(line[-1]) != i:
