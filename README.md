...
- Format Friends banlist updater beta.py: program to update a banlist based on the contents pulled from Edopro decklists.
- Everchange.py: program to grab a banlist from a github raw page and edit it. currently used for everchanging format, but easily adaptable.
_____
Also check:
